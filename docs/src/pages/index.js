  ...
  return (
    <>
       <div className={styles.feature}>
        ...
        <a className={clsx("button button--outline", styles.featureButton)}>Find out more</a>
      </div>
      ...
      <div className={clsx("card", styles.actionsPreviewCard)}>
        <div className={clsx("card__body", styles.cardBodyHero)}>
          <div className={styles.arrowContainer}>
            <div className={styles.manipulateUp}><ArrowDown/></div>
            <div className={styles.drivesUp}><ArrowDown/></div>
          </div>
          ...
          <div className={styles.arrowContainer}>
            <div className={styles.manipulateDown}><ArrowUp/></div>
            <div className={styles.drivesDown}><ArrowUp/></div>
          </div>
        </div>
      </div>
