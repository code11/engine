module.exports = {
  ...
  themeConfig: {
    ...
    footer: {
      style: "light",
      copyright: `Copyright © ${new Date().getFullYear()} <span>Code<sup>11</sup></span>, Inc. Built with <span>Docusaurus</span>.`,
    },
  },
  presets: [
    [
      "@docusaurus/preset-classic",
      {
        ...
        theme: {
          customCss:[require.resolve("./src/css/custom.css"), require.resolve("./src/css/tooltips.css")],
        },
      },
    ],
  ],
